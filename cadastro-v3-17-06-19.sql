...
(1, 33451, 33444, 1, 2, '2019-06-16 14:06:50'),
(2, 33451, 33444, 1, 2, '2019-06-16 14:07:16');
...
--
-- Estrutura da tabela `sistematags`
--

CREATE TABLE `sistematags` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Extraindo dados da tabela `sistematags`
--

INSERT INTO `sistematags` (`id`, `nome`, `caracteristicas`) VALUES
(1, 'Bonieky', 'Legal, Extrovertido, Brincalhão, Leal'),
(2, 'Fulano', 'Interessante, Bonito, Introvertido, Legal'),
(3, 'Cicrano', 'Brincalhão, Legal, Extrovertido');
...
--
-- Indexes for table `gafanhotos`
--
ALTER TABLE `gafanhotos`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `galeriausers`
--
ALTER TABLE `galeriausers`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `historicobanco`
--
...
--
-- Indexes for table `sistemacomentarios`
--
...
--
-- Indexes for table `sistematags`
--
ALTER TABLE `sistematags`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `gafanhotos`
--
ALTER TABLE `gafanhotos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;

--
-- AUTO_INCREMENT for table `galeriausers`
--
ALTER TABLE `galeriausers`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;

--
-- AUTO_INCREMENT for table `historicobanco`
--
ALTER TABLE `historicobanco`
...
--
-- AUTO_INCREMENT for table `sistemacomentarios`
--
ALTER TABLE `sistemacomentarios`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `sistematags`
--
ALTER TABLE `sistematags`
