...
--
-- Host: 127.0.0.1
-- Tempo de geração: 17-Jun-2019 às 01:09
...
(1, 'Felipy Camargo de Souza', 8695, 33451, 1, '2527d6ee36e5d91ced907633b787976c', 180000),
(2, 'Diego Bartolomeu', 2222, 33444, 1, '2527d6ee36e5d91ced907633b787976c', 145345);
...
--
-- Extraindo dados da tabela `historicobanco`
--

INSERT INTO `historicobanco` (`id`, `de`, `para`, `tipo`, `valor`, `data_operacao`) VALUES
(1, 33451, 33444, 0, 2, '2019-06-16 14:06:50'),
(2, 33451, 33444, 0, 2, '2019-06-16 14:07:16'),
(3, 33451, 33444, 0, 2, '2019-06-16 14:16:16'),
(4, 33451, 33444, 0, 2, '2019-06-16 14:22:11'),
(5, 33451, 33444, 0, 2, '2019-06-16 14:22:57'),
(6, 33451, 33444, 0, 2, '2019-06-16 14:23:34'),
(7, 33451, 33444, 0, 2, '2019-06-16 14:27:01'),
(8, 33451, 33444, 1, 325, '2019-06-16 14:31:30'),
(9, 33451, 33444, 1, 325, '2019-06-16 14:31:55'),
(10, 33451, 33444, 1, 325, '2019-06-16 14:33:42'),
(11, 33451, 33444, 1, 2, '2019-06-16 19:45:37'),
(12, 33451, 33444, 1, 2, '2019-06-16 19:51:09'),
(13, 33451, 33444, 1, 2, '2019-06-16 19:51:50'),
(14, 33451, 33444, 1, 2, '2019-06-16 19:51:59'),
(15, 33451, 33444, 1, 4346, '2019-06-16 19:56:37'),
(16, 33451, 33444, 1, 20000, '2019-06-16 19:57:09'),
(17, 33451, 33444, 1, 20000, '2019-06-16 20:05:52');
...
CREATE TABLE `sistemacomentarios` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Índices para tabela `galeriausers`
--
ALTER TABLE `galeriausers`
  ADD PRIMARY KEY (`id`);

--
-- Índices para tabela `historicobanco`
--
ALTER TABLE `historicobanco`
  ADD PRIMARY KEY (`id`);
...
--
-- Índices para tabela `sistemacomentarios`
--
ALTER TABLE `sistemacomentarios`
  ADD PRIMARY KEY (`id`),
  ADD KEY `donocomentario` (`donocomentario`);
...
--
-- AUTO_INCREMENT de tabela `galeriausers`
--
ALTER TABLE `galeriausers`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;

--
-- AUTO_INCREMENT de tabela `historicobanco`
--
ALTER TABLE `historicobanco`
...
--
-- AUTO_INCREMENT de tabela `sistemacomentarios`
--
ALTER TABLE `sistemacomentarios`
